...
# JSONB型 with indexの更新クエリ
JSONB_INDEX_UPDATE_QUERY = """
UPDATE company_jsonb_index
SET details = jsonb_set(details, '{補助金}', '"東京都補助金"'::jsonb)
WHERE details->>'営業時間' = '24時間'
  AND prefecture = 'Tokyo'
  AND industry = '飲食業';
...
if __name__ == "__main__":
    ...
    print("JSONB型 with indexの更新処理:")
    update_and_measure(JSONB_INDEX_UPDATE_QUERY, "company_jsonb_index")
